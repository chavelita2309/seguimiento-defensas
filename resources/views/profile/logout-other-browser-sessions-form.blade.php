<x-action-section>
    ...
    <x-slot name="description">
        {{ __('Gestionar y cerrar sesión en sus sesiones activas en otros navegadores y dispositivos.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puede cerrar sesión en todas sus otras sesiones de navegador en todos sus dispositivos. Algunas de sus sesiones recientes se enumeran a continuación; sin embargo, esta lista puede no ser exhaustiva. Si siente que su cuenta ha sido comprometida, también debe actualizar su contraseña.') }}
        </div>
