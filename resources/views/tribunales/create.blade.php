<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl">Sistema Web de Seguimiento y Control de Titulación - Registro de Tribunales
        </h2>
    </x-slot>
    <div class='flex items-center justify-center min-h-screen from-teal-100 via-teal-300 to-teal-500 bg-gradient-to-br'>
        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
            <div class='max-w-md mx-auto space-y-6'>
                ...
                <form action="{{ route('tribunales.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <h2 class="text-2xl font-bold">Nuevo tribunal</h2>
                    <p class="my-4 opacity-70">Registre los datos del tribunal</p>
                    <hr class="my-6">
