<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl">Sistema Web de Seguimiento y Control de Titulación - Registro de Postulantes
        </h2>
    </x-slot>
        ...
        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
            <div class='max-w-md mx-auto space-y-6'>
                ...
                <form action="{{ route('postulantes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <h2 class="text-2xl font-bold">Nuevo postulante</h2>
                    <p class="my-4 opacity-70">Registre los datos del postulante</p>
                    <hr class="my-6">
